...
import AccountMetadataModal from '../dashboard/AccountMetadataModal';
          ...
          >
            <div className="flex divide-x divide-gray-100 dark:divide-gray-800">
              ...
              <button
                ...
                className="flex-1 flex items-center justify-center gap-1.5 py-2 text-xs text-gray-600 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
              >
...
const MobileNetWorthView = ({
  ...
  // Handle opening account detail sheet
  ...
  // Handle saving metadata (delegated to parent)
  const handleSaveMetadata = async (accountId, metadata) => {
    await updateAccountMetadata(accountId, metadata);
  ...
  return (
    <div className="space-y-3 pb-20">
      ...
      <AccountDetailSheet
        ...
        accountType={detailAccount?.type || 'asset'}
        currentValue={detailAccount ? getDisplaySnapshotValue(detailAccount.id, selectedMonth) : 0}
        selectedMonth={selectedMonth}
        selectedYear={selectedYear}
        getSnapshotValue={getDisplaySnapshotValue}
        formatCurrency={formatCurrency}
